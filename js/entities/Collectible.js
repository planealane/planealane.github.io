...
import { UpgradesConfig } from '../config/UpgradesConfig.js'; // [MODIFIÉ] Pointeur mis à jour
...
export class Collectible extends BaseItem {
    constructor(x, y, image, type, tierIndex = 0) {
        ...
        // [MODIFIÉ] On pointe désormais sur UpgradesConfig.PORTALS
    ...
    draw(ctx) {
        // Applique l'effet de flottaison uniquement pour le rendu (pas pour la hitbox physique)
